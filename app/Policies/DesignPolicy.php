...
class DesignPolicy
{
    ...
    {
        //------------------------------------------------------------------------------------------
        //  Only allow updating of the design if the logged in
        //  user_id matches the design user_id that created it
        //
    ...
    {
        //------------------------------------------------------------------------------------------
        //  Only allow deleting of the design if the logged in
        //  user_id matches the design user_id that created it
        //
        return $design->user_id === $user->id;
        //------------------------------------------------------------------------------------------
