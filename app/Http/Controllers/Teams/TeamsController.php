...
{
    //------------------------------------------------------------------------
    //  Here we inject the Team Repository into this controller
    //  which then gives us access to all the methods defined in the
    //  interface contract and in the base repository
    //
    protected $teams;
    protected $users;
